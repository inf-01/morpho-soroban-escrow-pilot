function approveMilestone() {
    ...
    const hitoContainer = document.getElementById('hito-2-container');
    ...
    setTimeout(() => {
        ...
        hitoContainer.style.borderColor = 'var(--primary)';
        ...
        // Mensaje
        showNotification("¡Éxito! Pago de $40,000 liberado por CRJungle.");
